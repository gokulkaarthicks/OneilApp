...
// Dummy data with proper diversity
const coalMinesData = [
    ...
    { name: "Mine E", lat: 39.7392, lng: -104.9903, state: "Colorado", mineral: "Coal", company: "MiningCorp", project: "Refining", type: "Abandoned", yearOpened: 2000 },
...
function App() {
    ...
    // Filtered mines based on selection
